    ...
    <div className="flex flex-col w-full">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <div className="bg-background p-8 border border-border-color hover:border-primary/50 transition-colors shadow-lg">
                <h3 className="text-xl font-black italic uppercase text-foreground mb-3">PHYSICAL DOMINANCE</h3>
              ...
              <div className="bg-background p-8 border border-border-color hover:border-primary/50 transition-colors shadow-lg">
                <h3 className="text-xl font-black italic uppercase text-foreground mb-3">MENTAL CLARITY</h3>
                <p className="text-xs text-foreground/70 leading-relaxed font-medium">
              ...
              <div className="bg-background p-8 border border-border-color hover:border-primary/50 transition-colors shadow-lg">
                <h3 className="text-xl font-black italic uppercase text-foreground mb-3">GENETIC LONGEVITY</h3>
                <p className="text-xs text-foreground/70 leading-relaxed font-medium">
            ...
            <div className="relative h-[600px] rounded-xl overflow-hidden shadow-2xl border border-border-color">
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl font-black italic uppercase tracking-widest mb-6 text-foreground">FUEL FOR <span className="text-primary">RESULTS</span></h2>
            <p className="text-sm text-foreground/80 leading-relaxed font-medium mb-10">
            ...
            <ul className="space-y-6">
              <li className="flex gap-4">
                ...
                <div>
                  <h4 className="text-[11px] font-bold uppercase tracking-widest text-foreground mb-1">MACRO TRACKING PRECISION</h4>
                  <p className="text-[10px] text-foreground/70">Understanding your protein, carbs, and fats is non-negotiable for muscle synthesis and fat loss.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <svg className="w-6 h-6 text-primary shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                <div>
                  <h4 className="text-[11px] font-bold uppercase tracking-widest text-foreground mb-1">MICRO-NUTRIENT MATRIX</h4>
                  <p className="text-[10px] text-foreground/70">Vitamins and minerals dictate cellular performance and prevent the deficiencies needed for optimal recovery.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <svg className="w-6 h-6 text-primary shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                <div>
                  <h4 className="text-[11px] font-bold uppercase tracking-widest text-foreground mb-1">PERFORMANCE HYDRATION</h4>
                  <p className="text-[10px] text-foreground/70">Cellular volumization and water intake to sustain power output during the toughest sessions.</p>
                </div>
              </li>
            </ul>
          </div>
      ...
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-background border border-border-color p-6 hover:border-primary transition-colors text-center">
              ...
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-foreground mb-2">SLEEP OPTIMIZATION</h4>
              <p className="text-[9px] text-foreground/60">Theoretical schedules to maximize release and tissue repair of optimal hormones.</p>
            </div>
            <div className="bg-background border border-border-color p-6 hover:border-primary transition-colors text-center">
              ...
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-foreground mb-2">THERMAL THERAPY</h4>
              <p className="text-[9px] text-foreground/60">Sauna and cold plunge integrations to manage inflammation.</p>
            </div>
            <div className="bg-background border border-border-color p-6 hover:border-primary transition-colors text-center">
              ...
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-foreground mb-2">STRESS MANAGEMENT</h4>
              <p className="text-[9px] text-foreground/60">Downshift the nervous system and upgrade your central system architecture.</p>
            </div>
            <div className="bg-background border border-border-color p-6 hover:border-primary transition-colors text-center">
              <svg className="w-8 h-8 text-primary mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-foreground mb-2">BIO-DATA ANALYSIS</h4>
              <p className="text-[9px] text-foreground/60">Heart Rate Variability (HRV) checks to decide when to push and when to rest.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-background border-t-4 border-primary p-12 md:p-16 flex flex-col md:flex-row items-center gap-12 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
            <div className="md:w-2/3">
              ...
              <h2 className="text-4xl font-black italic uppercase tracking-widest mb-6 text-foreground">DAILY<br/>COMMITMENT</h2>
            ...
            <div className="md:w-1/3 flex justify-center">
              <div className="w-48 h-48 rounded-full border-[8px] border-darker bg-background shadow-[0_0_30px_rgba(255,255,255,0.05)] inset-shadow flex items-center justify-center relative overflow-hidden">
                <div className="w-32 h-32 rounded-full border border-border-color flex items-center justify-center">
      ...
      {/* CTA Section */}
      <section className="bg-background text-foreground py-32 mx-0 text-center relative overflow-hidden border-t border-border-color">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link href="/contact" className="bg-primary hover:bg-primary-hover text-primary-content text-sm font-bold uppercase tracking-widest py-5 px-12 transition-all shadow-[0_0_30px_rgba(207,255,4,0.5)] hover:scale-105">
              START YOUR JOURNEY
            </Link>
            <Link href="/contact" className="bg-transparent border-2 border-border-color hover:bg-foreground hover:text-background text-foreground text-sm font-bold uppercase tracking-widest py-5 px-12 transition-colors">
              BOOK A FREE TOUR
            </Link>
          </div>
        </div>
