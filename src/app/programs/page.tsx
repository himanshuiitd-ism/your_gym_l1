    ...
    <div className="flex flex-col w-full">
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 relative h-[500px] bg-black group overflow-hidden">
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end bg-gradient-to-t from-darker via-darker/80 to-transparent">
              <div className="bg-primary text-black text-[10px] font-bold uppercase tracking-widest py-1 px-2 mb-4 self-start">ELITE LEVEL</div>
              <h3 className="text-3xl md:text-4xl font-black italic uppercase mb-4">PERSONAL TRAINING</h3>
          ...
          <div className="bg-black border border-[rgba(0,0,0,0.4)] flex flex-col h-[500px]">
            ...
            <div className="p-8 flex flex-col flex-grow bg-black">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-center text-[10px] text-white/80 font-bold uppercase tracking-widest">
          ...
          <div className="md:col-span-2 md:col-start-1 bg-black border border-[rgba(0,0,0,0.4)] flex flex-col md:flex-row h-auto md:h-[300px]">
             ...
             <div className="p-8 flex flex-col justify-center md:w-1/2">
               ...
               <Link href="/facilities" className="border border-[rgba(0,0,0,0.4)] hover:bg-black-border text-white text-xs font-bold uppercase tracking-widest py-3 px-6 text-center transition-colors">
                 VIEW SCHEDULE
               </Link>
             </div>
          </div>
          ...
          {/* Card 4: Bio-Recovery */}
          <div className="bg-black border border-[rgba(0,0,0,0.4)] flex flex-col h-auto md:h-[300px]">
            ...
            <div className="p-6 flex flex-col flex-grow justify-between">
               ...
               <Link href="/facilities" className="border border-[rgba(0,0,0,0.4)] hover:bg-black-border text-white text-[10px] font-bold uppercase tracking-widest py-3 px-6 text-center transition-colors mt-auto">
                 EXPLORE SPA
               </Link>
            </div>
          </div>
      ...
      <section className="bg-primary text-black">
        <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center justify-between">
          ...
          <Link href="/contact" className="bg-black hover:bg-black text-white text-sm font-bold uppercase tracking-widest py-4 px-10 transition-colors z-10 relative">
            BOOK A SESSION
          </Link>
        </div>
      </section>
      ...
      {/* Stats Section */}
      <section className="bg-black py-16 border-b border-[rgba(0,0,0,0.4)]">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            <div className="text-primary text-3xl font-black italic mb-2">150+</div>
            <div className="text-[10px] text-white/60 font-bold tracking-widest uppercase">ELITE ATHLETES</div>
          </div>
          <div>
            <div className="text-primary text-3xl font-black italic mb-2">12</div>
            <div className="text-[10px] text-white/60 font-bold tracking-widest uppercase">PRO COACHES</div>
          </div>
          <div>
            <div className="text-primary text-3xl font-black italic mb-2">24/7</div>
            <div className="text-[10px] text-white/60 font-bold tracking-widest uppercase">DATA MONITORING</div>
          </div>
          <div>
            <div className="text-primary text-3xl font-black italic mb-2">0%</div>
            <div className="text-[10px] text-white/60 font-bold tracking-widest uppercase">EXCUSE TOLERANCE</div>
          </div>
        </div>
      </section>
    </div>
