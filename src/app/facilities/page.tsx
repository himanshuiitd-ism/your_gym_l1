    ...
    <div className="flex flex-col w-full">
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 border-b border-[rgba(0,0,0,0.4)] pb-4 gap-4">
            <h2 className="text-3xl font-black italic uppercase tracking-widest">THE ARSENAL</h2>
            <p className="text-[10px] text-white/60 font-bold tracking-widest uppercase max-w-sm text-left md:text-right">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 relative h-[400px] md:h-[600px] group overflow-hidden">
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end bg-gradient-to-t from-darker via-darker/50 to-transparent">
                <div className="bg-primary text-black text-[10px] font-bold uppercase tracking-widest py-1 px-2 mb-2 self-start">CARDIO PEAK</div>
                <h3 className="text-3xl font-black italic uppercase">ELITE ENDURANCE</h3>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6 h-[400px] md:h-[600px]">
              {/* Iron Zone */}
              <div className="relative h-1/2 group overflow-hidden bg-black">
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-end bg-gradient-to-t from-darker to-transparent">
                  <h3 className="text-2xl font-black italic uppercase">IRON ZONE</h3>
                </div>
              </div>
              ...
              <div className="relative h-1/2 group overflow-hidden bg-black">
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-end bg-gradient-to-t from-darker to-transparent">
                  <h3 className="text-2xl font-black italic uppercase">PRECISION RIGS</h3>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <ul className="space-y-10">
              <li className="flex gap-4">
                <div className="mt-1">
                  <div className="w-8 h-8 bg-black border border-[rgba(0,0,0,0.4)] flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/70 leading-relaxed">Detoxify and accelerate muscle recovery in our custom built 180°F infrared thermal chambers.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="mt-1">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/70 leading-relaxed">Private marble showers, premium grooming products, and secure digital biometric lockers.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="mt-1">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/70 leading-relaxed">Sub-zero recovery sessions designed to reduce inflammation and spark CNS rejuvenation.</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="relative h-[500px] border border-primary/30 p-2 transform rotate-1">
            <div className="relative w-full h-full transform -rotate-1 overflow-hidden bg-black">
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-black p-10 border-t-2 border-primary">
      ...
      {/* CTA Section */}
      <section className="bg-primary text-black py-24 mx-6 mb-24 max-w-7xl md:mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link href="/contact" className="bg-black hover:bg-black text-white text-xs font-bold uppercase tracking-widest py-4 px-10 transition-colors">
            BOOK A TOUR
          </Link>
          <Link href="/contact" className="bg-transparent border-2 border-darker hover:bg-black hover:text-white text-darker text-xs font-bold uppercase tracking-widest py-4 px-10 transition-colors">
            VIEW PRICING
          </Link>
        </div>
      </section>
