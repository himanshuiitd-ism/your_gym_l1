    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-6 max-w-7xl mx-auto w-full pt-10">
          <div className="inline-block bg-primary text-black text-xs font-bold uppercase tracking-widest py-1 px-3 mb-6 shadow-[0_0_10px_rgba(207,255,4,0.5)]">
            ESTABLISHED 2024
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="/contact" className="bg-primary hover:bg-primary-hover text-black text-sm font-bold uppercase tracking-widest py-4 px-8 transition-all hover:scale-105 shadow-[0_0_20px_rgba(207,255,4,0.6)]">
              JOIN THE ELITE
            </Link>
            <Link href="/programs" className="bg-[rgba(0,0,0,0.4)] backdrop-blur-sm border border-[rgba(0,0,0,0.4)] text-white hover:bg-white hover:text-black text-sm font-bold uppercase tracking-widest py-4 px-8 transition-colors">
              VIEW PROGRAMS
            </Link>
          </div>
        </div>
        ...
        <div className="absolute bottom-[-5%] right-0 z-0 pointer-events-none overflow-hidden">
          <h2 className="text-[8rem] md:text-[14rem] font-black italic uppercase text-white/10 whitespace-nowrap leading-none tracking-tighter drop-shadow-2xl">
            ZERO EXCUSES
          </h2>
        </div>
      </section>
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-end mb-12 border-b border-[rgba(0,0,0,0.4)] pb-4">
            <h2 className="text-3xl font-black italic uppercase tracking-widest text-white drop-shadow-lg">ENGINEERED FOR RESULTS</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 relative h-[400px] md:h-[500px] bg-black overflow-hidden shadow-2xl border border-[rgba(0,0,0,0.4)] hover:border-primary/50 transition-colors">
            ...
            {/* Card 03 */}
            <div className="relative h-[400px] md:h-[500px] bg-black overflow-hidden shadow-2xl border border-[rgba(0,0,0,0.4)] hover:border-primary/50 transition-colors">
            ...
            {/* Card 04 */}
            <div className="md:col-span-2 bg-black border border-[rgba(0,0,0,0.4)] hover:border-primary/50 transition-colors p-12 flex flex-col justify-center items-center text-center h-[400px] md:h-[500px] shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <Link href="/facilities" className="bg-primary hover:bg-primary-hover text-black text-sm font-bold uppercase tracking-widest py-4 px-10 transition-colors shadow-[0_0_15px_rgba(207,255,4,0.5)] inline-block">
                  LEARN MORE
                </Link>
              </div>
            </div>
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-6 text-center mb-16">
          <h2 className="text-3xl font-black italic uppercase tracking-widest mb-4 text-white">DOMINATE YOUR DISCIPLINE</h2>
          <p className="text-base text-white/80 max-w-xl mx-auto leading-relaxed font-medium">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Program 1 */}
          <div className="relative h-[600px] group overflow-hidden rounded-xl shadow-2xl border border-[rgba(0,0,0,0.4)] hover:border-primary/50 transition-all">
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end bg-gradient-to-t from-darker via-darker/60 to-transparent">
              <div className="bg-primary text-black text-xs font-bold uppercase tracking-widest py-1 px-3 mb-4 self-start shadow-[0_0_10px_rgba(207,255,4,0.5)]">INTENSITY EXTREME</div>
          ...
          <div className="relative h-[600px] group overflow-hidden rounded-xl shadow-2xl border border-[rgba(0,0,0,0.4)] hover:border-primary/50 transition-all">
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-end bg-gradient-to-t from-darker via-darker/60 to-transparent">
              <div className="bg-black text-white text-xs font-bold uppercase tracking-widest py-1 px-3 mb-4 self-start border border-[rgba(0,0,0,0.4)]">RECOVERY FOCUSED</div>
      ...
      {/* Stats Bar */}
      <section className="py-20 bg-black border-y border-[rgba(0,0,0,0.4)] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center relative z-10">
          <div className="p-6 bg-[rgba(0,0,0,0.4)] backdrop-blur-md rounded-lg border border-[rgba(0,0,0,0.4)] hover:border-primary/30 transition-colors">
            <div className="text-primary text-4xl font-black italic mb-2 drop-shadow-[0_0_10px_rgba(207,255,4,0.4)]">800+</div>
            <div className="text-xs font-bold tracking-widest uppercase text-white">ELITE MEMBERS</div>
          </div>
          <div className="p-6 bg-[rgba(0,0,0,0.4)] backdrop-blur-md rounded-lg border border-[rgba(0,0,0,0.4)] hover:border-primary/30 transition-colors">
            <div className="text-primary text-4xl font-black italic mb-2 drop-shadow-[0_0_10px_rgba(207,255,4,0.4)]">35+</div>
            <div className="text-xs font-bold tracking-widest uppercase text-white">PRO COACHES</div>
          </div>
          <div className="p-6 bg-[rgba(0,0,0,0.4)] backdrop-blur-md rounded-lg border border-[rgba(0,0,0,0.4)] hover:border-primary/30 transition-colors">
            <div className="text-primary text-4xl font-black italic mb-2 drop-shadow-[0_0_10px_rgba(207,255,4,0.4)]">15k</div>
            <div className="text-xs font-bold tracking-widest uppercase text-white">SQ FT FACILITY</div>
          </div>
          <div className="p-6 bg-[rgba(0,0,0,0.4)] backdrop-blur-md rounded-lg border border-[rgba(0,0,0,0.4)] hover:border-primary/30 transition-colors">
            <div className="text-primary text-4xl font-black italic mb-2 drop-shadow-[0_0_10px_rgba(207,255,4,0.4)]">24/7</div>
            <div className="text-xs font-bold tracking-widest uppercase text-white">ACCESS GRANTED</div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-40 overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          ...
          <Link href="/contact" className="inline-block bg-primary hover:bg-primary-hover text-black text-lg font-bold uppercase tracking-widest py-5 px-14 transition-all shadow-[0_0_40px_rgba(207,255,4,0.5)] hover:scale-105 hover:shadow-[0_0_60px_rgba(207,255,4,0.8)]">
            CLAIM YOUR PASS
          </Link>
        </div>
      </section>
